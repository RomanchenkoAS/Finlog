    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.warning(
                    request, f'Authentication failed: user does not exist')
                ...
                if user is not None:
                    ...
                    messages.warning(
                        request, f'Authentication failed: password mismatch')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user = User.objects.create_user(
                username, email=None, password=password, budget=budget, currency=currency)

            messages.success(
                request, f'You have successfully registered, {user.username}! Use your login & password to enter.')
