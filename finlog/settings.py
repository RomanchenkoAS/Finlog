"""
Django settings for finlog project.
...
ALLOWED_HOSTS = ['127.0.0.1:8000/', 'finlog.pythonanywhere.com/']
...
WSGI_APPLICATION = 'finlog.wsgi.application'
